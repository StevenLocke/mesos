...
def completions(comp_words, current_word, argv):
    """
    Helps autocomplete by returning appropiate
    completion words if applicable
    """
...
def format_commands_help(cmds):
    """
    Helps format Plugin info for display
    """
...
def format_subcommands_help(cmd):
    """
    Helps format Plugin command info for display
    """
